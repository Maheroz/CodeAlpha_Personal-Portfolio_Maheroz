...
readMore.addEventListener("click", function () {
    ...
    if (readMore.classList.contains("clicked")) {
        aboutMeText.textContent =
            "Hey there! Maheroz, a B.Tech graduate and full-stack web development. I love turning ideas into functional websites and applications. Passionate about creativity and problem-solving. Along the way, I've honed my skills in front-end and back-end technologies.";
...
function sendEmail() {
    ...
    Email.send({
        ...
        Username: "maheroz69@gmail.com",
        Password: "09F485E524",
        To: "maheroz69@gmail.com",
        From: "maheroz69@gmail.com",
        Subject: sub.value,
        Body: bodyMesg,
    }).then((message) =>
